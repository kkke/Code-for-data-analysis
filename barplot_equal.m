...
figure;
bar(1,m1,'EdgeColor',[0 0 0],'FaceColor','r','LineWidth',1.5);hold on
bar(2,m2,'EdgeColor',[0 0 1],'FaceColor','g','LineWidth',1.5);hold on
bar(3,m3,'EdgeColor',[0 0 1],'FaceColor','g','LineWidth',1.5);hold on
set(gca,'XTick',0:4)
